...
export class ManageUsersComponent implements OnInit {
  ...
  ngOnInit(): void {         //we are going to start the loader here
  ...
  handleAddAction(){
    ...
    this.router.events.subscribe(()=>{         // this is used so that when the server didn't got proper response for adding user then it should revert back to homepage.
      dialogRef.close();
    });
